...
def rotate_retarded_set(image_paths, mask_paths): 
    for i in range(len(mask_paths)):
        ...
        if(image[:, :, 0].shape != mask[:, :, 0].shape):
            ...
            tf.io.write_file(image_paths[i], encoded_image)
...
def display_from_path(image_path, mask_path, save_instead):
    ...
    if(save_instead):
        plt.savefig(f"benchmark2/image_{i}.png", bbox_inches='tight')
    else:
        plt.show()
...
# model = load_model("trained_models/run_58/cs_test_256_50.keras")
# model = load_model("512_log_train/run_3/lunet_model_with_batchnorm/bs_25/dc_0.95/ep_48_model.keras")
# model = load_model("512_log_train/run_3/lunet_model_with_both/bs_8/dc_0.85/ep_48_model.keras")
# model = load_model("512_log_train/run_3/lunet_model_with_both/bs_16/dc_0.9/ep_48_model.keras")

# model = load_model("/home/burk/Documents/cuda_test/newlog/trained_models/run_78/first_q_prep_512_30.keras")
model = load_model("/home/burk/Documents/cuda_test/newlog/512_dynamic_unet/run_6_middle_only/bs_8/dr_0.95/w_3/h_6/_model_fin.keras")
#model = load_model("/home/burk/Documents/cuda_test/newlog/512_dynamic_unet/run_7_combined/bs_8/dr_0.9/n_660/w_3/h_6/_model_fin.keras")
test_image_dir = 'dataset/split_images2/val'
test_mask_dir = 'dataset/split_images2/val_mask'
test_dataset, image_paths, mask_paths = create_dataset(test_image_dir, test_mask_dir, batch_size=1)

# test_image_dir = 'dataset/cross_sections/local'
# test_mask_dir = 'dataset/cross_sections/local_combine_mask'
...
for images, masks in test_dataset:  
    ...
    # Save to file
    plt.savefig(f"middle_only/image_{i}.png", bbox_inches='tight')
